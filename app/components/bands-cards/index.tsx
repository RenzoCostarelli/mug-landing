...
const dummyData: Band[] = [
    {
      img_url: 'https://res.cloudinary.com/dkgnaegp9/image/upload/v1694715770/choke_vly6d8.jpg',
      link_url: 'https://open.spotify.com/artist/2MGzb68P8ec7JFuzkwi0sJ',
      title: 'Chokenbici',
      description: 'Feel the funk and groove with the master!',
    },
    {
      img_url: 'https://res.cloudinary.com/dkgnaegp9/image/upload/v1694715770/caliope_swkx9j.jpg',
    ...
    {
      img_url: 'https://res.cloudinary.com/dkgnaegp9/image/upload/v1694715770/cortito_y7nuhl.jpg',
    ...
    {
      img_url: 'https://res.cloudinary.com/dkgnaegp9/image/upload/v1694715771/grooving_wl5heg.jpg',
    ...
    {
      img_url: 'https://res.cloudinary.com/dkgnaegp9/image/upload/v1694715771/joako22_z4swou.jpg',
    ...
    {
      img_url: 'https://res.cloudinary.com/dkgnaegp9/image/upload/v1694715772/latelo_wipviw.jpg',
    ...
    {
      img_url: 'https://res.cloudinary.com/dkgnaegp9/image/upload/v1694715771/lann_h2x0m2.jpg',
      link_url: 'https://open.spotify.com/artist/6MgMaAZpctJvlIEKrkvDtC',
      title: 'La N.N',
      description: 'Join the revolution of funky rhythms and moves!',
    },
    {
      img_url: 'https://res.cloudinary.com/dkgnaegp9/image/upload/v1694715772/suave_l2yx8l.jpg',
    ...
    {
      img_url: 'https://res.cloudinary.com/dkgnaegp9/image/upload/v1694715772/trigga_whgkmg.jpg',
      link_url: 'https://soundcloud.com/triganigga-dj',
      title: 'Triga Nigga',
      description: 'Vibes so funky, they`ll make you move instantly!',
    },
    {
      img_url: 'https://res.cloudinary.com/dkgnaegp9/image/upload/v1694715769/bifes_uh4cas.jpg',
